...
public class fastaParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "COMMENTLINE", "DESCRIPTIONLINE", "TEXT", "EOL", "SEQUENCELINE"
	};
	public static final int
	...
	public static class SequenceContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fastaVisitor ) return ((fastaVisitor<? extends T>)visitor).visitSequence(this);
	...
	public static class SectionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fastaVisitor ) return ((fastaVisitor<? extends T>)visitor).visitSection(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SequencelinesContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fastaVisitor ) return ((fastaVisitor<? extends T>)visitor).visitSequencelines(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DescriptionlineContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fastaVisitor ) return ((fastaVisitor<? extends T>)visitor).visitDescriptionline(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CommentlineContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof fastaVisitor ) return ((fastaVisitor<? extends T>)visitor).visitCommentline(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\22\3\2\2\2\24\23\3\2\2\2\25\5\3\2\2\2\26\30\7\7\2\2\27\26\3\2\2\2\30"+

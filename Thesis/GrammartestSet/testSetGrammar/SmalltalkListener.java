...
public interface SmalltalkListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SmalltalkParser#StatementExpressionsAnswer}.
	 * @param ctx the parse tree
	 */
	void enterStatementExpressionsAnswer(@NotNull SmalltalkParser.StatementExpressionsAnswerContext ctx);
	/**
	 * Exit a parse tree produced by {@link SmalltalkParser#StatementExpressionsAnswer}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link SmalltalkParser#StatementExpressions}.
	 * @param ctx the parse tree
	 */
	void enterStatementExpressions(@NotNull SmalltalkParser.StatementExpressionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link SmalltalkParser#StatementExpressions}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link SmalltalkParser#StatementAnswer}.
	 * @param ctx the parse tree
	 */
	void enterStatementAnswer(@NotNull SmalltalkParser.StatementAnswerContext ctx);
	/**
	 * Exit a parse tree produced by {@link SmalltalkParser#StatementAnswer}.
	 * @param ctx the parse tree
	 */

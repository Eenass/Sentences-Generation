...
form
	:	( attribute|function|ruleClauses)  '.' 
	;
...
funClause
	:	argumentList clauseGuard clauseBody 
	;
...
tryClause
	:	( atomOrVar ':'  ) ?  expr clauseGuard clauseBody 
	;
...
ruleClause
	:	tokAtom clauseArgs clauseGuard ruleBody 
	;

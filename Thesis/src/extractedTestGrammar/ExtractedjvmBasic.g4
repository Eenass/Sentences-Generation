...
line
	:	( linenumber ( ( amprstmt ( COLON amprstmt?   ) *  ) |( COMMENT|REM) )  ( CR|EOF)   ) 
	|	CR 
	;
...
statement
	:	( LOAD|SAVE|TRACE|NOTRACE|FLASH|INVERSE|GR|NORMAL|SHLOAD|CLEAR|RUN|STOP|TEXT|HOME|HGR|HGR2) 
	|	endstmt
	|	returnstmt
	|	restorestmt
	|	amptstmt
